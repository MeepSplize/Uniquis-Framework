...
inline ID3D12CommandList* const* CommandListCast(t_CommandListType* const* pp)
{
	...
	// ExecuteCommandLists.
	// This cast is valid as long as the const-ness is respected. DirectX12 APIs do
	// respect the const-ness of their arguments.
	return reinterpret_cast<ID3D12CommandList* const*>(pp);
}

//------------------------------------------------------------------------------------------------
// DirectX12 exports a new method for serializing root signatures in the Windows 10 Anniversary Update.
